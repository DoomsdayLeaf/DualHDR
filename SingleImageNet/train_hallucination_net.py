...
# --- graph
class train_hallucination_net(object):
    def __init__(self, sess, args):
        ...
        self.batch_size = args.hall_batch_size
        self.it_num = args.hall_epoch
        self.logdir_path = args.hal_indi_log_dir
    ...
    def train(self):
        ...
        hallucination_net.load_vgg_weights(self.vgg16_conv_layers,
                                           'SingleImageNet/vgg16_places365_weights.npy', self.sess)
