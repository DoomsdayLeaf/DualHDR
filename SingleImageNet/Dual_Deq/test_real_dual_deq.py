...
class Test_Real(object):
    def __init__(self, sess, args):
        ...
        self.deq_train_ckpt = 'ckpt/dual_deq_synth_L2_d100k_d0_5/best/model.ckpt'
        self.output_path = '/home/shelei/HDR/Dataset/Test/HDR-Real/dual_deq_synth_L2_d100k_d0_5'
    ...
    def run_test(self):
        ...
        restorer0.restore(self.sess, self.deq_train_ckpt)
